Public Class FormTabella_Accettazione

    Private Sub FormTabella_Accettazione_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
